		  	...
		  	<div class="row">
                ...
                <div class="panel-title">Account Balance Report</div>
		  				...
		  				<div class="panel-body">
		  					<?php
                    require("connect.php");
                    $query_result = mysql_query("select * from withdraw") or die (mysql_error());
                    echo "<table align='center' border = 0 width='400px'>";
                    $i = 1; //set $i to 1 outside the loop
                    while ($row=mysql_fetch_array($query_result)){
                      echo "<td>"."<strong>"."Account No: "."</strong>"."<a href=viewCustP.php?no=$row[amount]>$row[amount]</a>"."<br />"
                        ."<strong>"."Amount Deposited: "."</strong>".$row['actNo']."<br />"."<br />".
