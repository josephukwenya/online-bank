...
<html>
  <head>
    ...
    <script language="JavaScript" type="text/javascript">
      ...
      if ((deposit.amt.value=="")||(deposit.actNo.value=="")){
    	...
    	<div class="row">
		  ...
		  <div class="col-md-10">
		  	<div class="row">
                ...
                <div class="panel-title">Deposit Interface</div>

              </div>
		  				<div class="panel-body">
		  					<form action="depositP.php" method="post" enctype="multipart/form-data" name="deposit" id="form1" onsubmit="return valForm(this);">
            <table width="445" border="0">
              ...
              <tr>
                ...
                <td colspan="2"><label for="textfield"></label>
                  <input name="amt" type="text" class="input" id="textfield" /></td>
                <td width="102">&nbsp;</td>
                </tr>
              <tr>
                <td>&nbsp;</td>
