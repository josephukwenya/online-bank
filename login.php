...
<html>
  <head>
    ...
    <<script language="JavaScript" type="text/javascript">
      ...
      if ((login.uName.value=="")||(login.pWord.value=="")){
        alert("some text missen");
        login.uName.focus();
            return false;
        }
        //  END 
		  	...
		  	<div class="row">
                ...
                <div class="panel-title"></div>
		  				...
		  				<div class="panel-body">
    		  					<form action="loginP.php" method="post" enctype="multipart/form-data" name="login" id="form1" onsubmit="return valForm(this);">
                <table width="445" border="0">
                  <tr>
                    <td width="103" nowrap="nowrap" style="text-align:right">USER NAME</td>
                    <td colspan="3"><input name="uName" type="text" class="input" /></td>
                    </tr>
                  <tr>
                    <td style="text-align:right">PASSWORD</td>
                    <td colspan="2"><label for="textfield"></label>
                      <input name="pWord" class="input" type="password" /></td>
                    <td width="102">&nbsp;</td>
                    </tr>
                  <tr>
                    <td>&nbsp;</td>
