		  	...
		  	<div class="row">
                ...
                <div class="panel-title"></div>
		  				...
		  				<div class="panel-body">
		  					   <?php
                    require("connect.php");
                    $query_result = mysql_query("select * from deposit") or die (mysql_error());
                    echo "<table align='center' border = 0 width='400px'>";
                    $i = 1; //set $i to 1 outside the loop
                    while ($row=mysql_fetch_array($query_result)){
                      echo "<td>"."<strong>"."Account No: "."</strong>"."$row[acctNo]"."<br />"
                        ."<strong>"."Amount "."</strong>".$row['amount']."<br />".
                        "<strong>"."Date of Deposit "."</strong>".$row['cDat']."<br />"."<br />".
